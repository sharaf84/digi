	...
	<div class="row">
		<div class="profile-section order-history">
			...
			<div class="as-table">
				...
				<div class="row as-table-head">
					<div class="large-4 medium-4 small-12 columns as-table-head-cell">
						Product
					</div>
				...
				<div class="row as-table-row">
					<div class="large-4 medium-4 small-12 columns as-table-cell">
						<div class="row">
							<div class="large-3 medium-3 small-12 columns product-image-cont">
								<img src="<?= Url::to('@frontThemeUrl') ?>/images/src/NITRO-TECH.png" alt="">
							</div>
							<div class="large-9 medium-9 small-12 columns product-info-cont">
								<h4>Casin-Peak ihner armor</h4>
								<p><strong>Flavour:</strong> chocolate - <strong>Size:</strong> 150g</p>
							</div>
						</div>
					</div>
					<div class="large-2 medium-2 small-12 columns as-table-cell">
